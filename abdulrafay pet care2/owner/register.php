...
<body>
    ...
    if (isset($_POST["btn"])) {
        ...
        $query1 = "SELECT * FROM owner_registration WHERE password='$password' and email='$email' and number='$number'";
        ...
        if (mysqli_num_rows($result1) > 0) {
            ...
            $query2 = "INSERT INTO owner_registration (name, email, number, address, password) 
